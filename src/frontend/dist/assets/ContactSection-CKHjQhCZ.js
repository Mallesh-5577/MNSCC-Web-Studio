...
function Contact() {
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          other_website_name: form.websiteType === "Others" ? form.otherWebsiteName : "",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "contact", className: "relative py-24 md:py-32 overflow-hidden", children: [
        ...
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-4", children: [
              "Let's Build Your ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text-cyan", children: "Website" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto text-base", children: "Ready to elevate your online presence? Drop us a message and we'll get back to you within 24 hours." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-12 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            transition: { duration: 0.6 },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-foreground mb-2", children: "Get in Touch" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-6", children: "Whether you have a specific project in mind or just want to explore possibilities, we'd love to hear from you. Every great website starts with a conversation." }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-green-500/20 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-5 h-5 text-green-400" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-foreground text-sm", children: "Chat on WhatsApp" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "Instant replies, quick discussion" })
                        ] })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "a",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-primary/20 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-5 h-5 text-primary" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-foreground text-sm", children: "Send an Email" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground", children: "malleshmudavath449@gmail.com" })
                        ] })
                      ]
                    }
                  )
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-lg p-4 flex items-center gap-3 border border-border/20", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-green-400 animate-pulse flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "Currently accepting projects." }),
                  " ",
          ...
          motion.div,
          {
            ...
            children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-green-500/15 flex items-center justify-center mb-4 border border-green-500/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-8 h-8 text-green-400" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xl font-bold text-foreground mb-2", children: "Message Sent!" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm max-w-xs", children: "Thank you for reaching out. We'll review your message and get back to you within 24 hours." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      variant: "outline",
                      ...
                      Select,
                      {
                        ...
                        onValueChange: (value) => {
                          setForm((f) => ({
                            ...f,
                            websiteType: value,
                            otherWebsiteName: value === "Others" ? f.otherWebsiteName : ""
                          }));
                          setErrors((prev) => ({
                            ...prev,
                            websiteType: void 0,
                            otherWebsiteName: value === "Others" ? prev.otherWebsiteName : void 0
                          }));
                        },
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            SelectTrigger,
                            {
                              ...
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select website type" })
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "bg-card border-border/30", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Business Website", children: "Business Website" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "E-Commerce Website", children: "E-Commerce Website" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Portfolio Website", children: "Portfolio Website" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Landing Page", children: "Landing Page" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Blog/News Website", children: "Blog/News Website" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Custom Web App", children: "Custom Web App" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Others", children: "Others" })
                          ] })
                        ]
                      }
                    ),
                    errors.websiteType && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.websiteType })
                  ] }),
                  form.websiteType === "Others" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Label,
                      {
                        htmlFor: "otherWebsiteName",
                        className: "text-sm font-medium text-foreground",
                        children: "Your Website Type"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Input,
                    ...
                    errors.otherWebsiteName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive", children: errors.otherWebsiteName })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Label,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-4 h-4 border-2 border-background/30 border-t-background rounded-full animate-spin" }),
                        "Sending..."
